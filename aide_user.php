...
color: #303952;
 font-size: 16px;
  text-align: left;
    ...
    /*************************Bouttons style**********************************/
    #myBtn1,#myBtn2,#myBtn3,#myBtn4,#myBtn7,#myBtn8,#myBtn13,#myBtn14,#myBtn15,#myBtn16,#myBtn17,#myBtn18,#myBtn19,#myBtn20,#myBtn23,#myBtn24,#myBtn25,#myBtn26,#myBtn27,#myBtn28,#myBtn29,#myBtn30,#myBtn31,#myBtn32,#myBtn33,#myBtn34,#myBtn35{
      color: #303952;
 font-size: 15px; 
font-family: "Helvetica Neue", Helvetica, Arial, sans-serif;  
    }
...
<div style="background-color:rgba(245,246,246,0.6);height:1728px;align-content: center;  margin-left: auto;
...
" >
  ...
  <div class="container list-group" style="width: 900px;opacity: 0.90;">
    <div class="row">
      ...
      <div class="col-lg-9" style="margin-top: -710px;margin-left:70px;width: 1000px;">
   ...
   <blockquote>
    ...
    <tbody>
      ...
      <tr class="info">
        <td><a id="myBtn2"  role="button">Comment visualiser toutes mes réservations en cours ?</a></td>
      </tr>

      <tr class="active">
        <td><a id="myBtn3" role="button">Comment modifier une réservation ?</a></td>
       </tr>

      <tr class="info">
        <td><a id="myBtn4" role="button">Comment annuler une réservation ?</a></td>
      </tr>
      <tr class="active">
 ...
 <!--*************************************************************************************-->
   ...
   <table class="table">
    ...
    <tbody>
      ...
      <tr  class="active">
        <td><a id="myBtn19" role="button">Qui sera notifié du changement de la réservation ?</a></td>
      </tr> 

      <tr class="info">
        <td><a id="myBtn20"  role="button">Qui d’autre que moi, pourra modifier ma réservation ?</a></td>
      </tr>
...
<div class="modal fade" id="myModal2" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:35px 50px;">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h6 class="titre1">Comment visualiser toutes mes réservations en cours ?</h6>
        </div>
        <div class="modal-body" style="padding:40px 50px;">
         <!-- Copier my steps -->
          <strong><p class="texte"> Pour consulter vos réservations en cours : </p>  </strong> 

      <p class="texte"><span class="badge" style="background-color: #07756a;">1</span> Cliquez sur le boutton <strong>Accueil</strong> que vous trouverez dans le menu.</p>
               
       <p class="texte"><span class="badge" style="background-color: #07756a;">2</span>  Vous pouvez ensuite visualiser vos réservations en attente de l'accord de l'administration , vos réservations accordées et vos réservations refusées par le service culturel de l'ESI.</p>
...
<div class="modal fade" id="myModal3" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:35px 50px;">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h6 class="titre1">Comment modifier une réservation ?</h6>
        </div>
        <div class="modal-body" style="padding:40px 50px;">
         <!-- Copier my steps -->
          <strong><p class="texte"> Pour modifier une réservation en cours : </p>  </strong> 

      <p class="texte"><span class="badge" style="background-color: #07756a;">1</span> Aller à l'accueil et cliquer sur le boutton <strong>modifier</strong> qui ce trouve dans la même ligne de votre réservation.</p>
               
       <p class="texte"><span class="badge" style="background-color: #07756a;">2</span> Vous serez redirigé vers la page de modification..</p>
...
<div class="modal fade" id="myModal4" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:40px 50px;">
         <!-- Copier my steps -->
          <strong><p class="texte"> Pour annuler une réservation en cours : </p>  </strong> 

      <p class="texte"><span class="badge" style="background-color: #07756a;">1</span> Aller à l'accueil et cliquer sur le boutton <strong>annuler</strong> qui ce trouve dans la même ligne de votre réservation.</p>
               
       <p class="texte"><span class="badge" style="background-color: #07756a;">2</span> vous serez redirigé vers une page de confirmation et votre réservation sera annulée.</p>
   ...
   <div class="modal fade" id="myModal17" role="dialog">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:35px 50px;">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h6 class="titre1">Qui sera notifié du changement de la réservation ?</h6>
        </div>
        <div class="modal-body" style="padding:40px 50px;">
         <!-- Copier my steps -->
          <strong><p class="texte">  -  Un e-mail de notification sera envoyé au service culturel de l’ESI après que vous ayez validé la modification de votre réservation.</p>  </strong> 
      </div>
        <div class="modal-footer">
          <button type="submit" class="btn btn-danger btn-default pull-left" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Fermer</button>
        </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:35px 50px;">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h6 class="titre1">Qui d’autre que moi, pourra modifier ma réservation ?</h6>
        </div>
        <div class="modal-body" style="padding:40px 50px;">
         <!-- Copier my steps -->
          <strong><p class="texte">  - L’administrateur (Le service culturel de l’ESI) est le seul utilisateur qui peut modifier votre réservation. Dans ce cas, vous serez notifié par e-mail. </p>  </strong> 
      </div>
        <div class="modal-footer">
          <button type="submit" class="btn btn-danger btn-default pull-left" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Fermer</button>
        </div>

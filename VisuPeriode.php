...
<html lang="en" dir="ltr">
  <head>
    <title> Visualisation par période </title>
...
// on vérifie dans le cas ou c'est un club
  ...
  else
  {
    ...
    <div id='calendar-container'>
      <form class="form-inline" action="CalendarPeriode.php" method="post"style="margin-left: 250px">
        <label style="margin-left: 40px"><h3>Veuillez choisir une période</h3> </label> <br> <br>
        <label for="datedeb" style="margin-right: 95px">Date de début: </label>
        <label for="datefin">  Date de fin: </label> <br>

          <input  type="date" class="form-control datepicker required " name="datedeb" style="margin-right: 40px" required>
        <input  type="date" class="form-control datepicker required " name="datefin"  required>
      <br> <br>
        <button type="submit" class="btn " style="color:#07756a">

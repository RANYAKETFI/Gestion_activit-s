  ...
  <body>
     ...
     <div class="container">
      ...
      box-shadow: 0px 0px 93px 49px rgba(245,246,246,1);  border-top-right-radius: 1.5rem;
        ...
        <h1  style=" color : #f5f6f6;">Entrez le nom d'utilisateur :</h1> <br>
        <form id="statistique" action="statisticsbyuser.php" method="post">
            <div class="form-group">
                <div class="input-group">
                   <span class="input-group-addon"><i class="fas fa-user"></i></span>
                    <input type="text" class="form-control" id="user" name="user" placeholder="Entrez le nom d'utilisateur" >
              </div>
            </div>
          <br>
          <div class="form-group ">

...
<html>
<head>
	<title>Modification du nom d'utilisateur</title>
         ...
         $( function(){
          $("#envoyer").click(function(){
            ...
            {  // $("#nom").css("border-color","#ff5b5b");
              $("#nom").next(".error-message").fadeIn().text("Veuillez entrer le nom de votre club");
...
<body  style="background-image: url('./images/bac.JPG');background-repeat: no-repeat;/*background-size:1400px 900px ;*/background-size:100% ;
  height: 100%;">
<?php
  $nom  = $pwd = "" ;
  $nomErr = $pwdErr = "" ;
...
box-shadow: 0px 0px 93px 49px rgba(245,246,246,1);  border-top-right-radius: 2rem;
    ...
    border-bottom-left-radius: 2rem; width: 800px; margin-right: auto;margin-left:500px;/*margin-left:410px;*/margin-top: -600px;margin-bottom: 15%; height:50%;padding: 2.5%;" >
       <h2 class="display-3" style=" text-align: center;color: #f5f6f6; font-weight: lighter; margin-top: -2%;line-height:1.5;"><br> <i class='fas fa-user-alt' style="color: #f5f6f6;"></i> Modification du nom d'utilisateur</h2>
...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" name="Formaulaire">
                                          ...
                                          <div class="row register-form">
                                            ...
                                            <label for="nom" style="line-height:1.5;color: #303952;font-size: 15px;"> Nouveau nom du club :</label>
                                            ...
                                            <input type="password" class="form-control" placeholder="Votre mot de passe  *"   name="pwd" id="pwd"  style="font-size: 15px;" /><span class="error-message text-danger" style="line-height:1.5;font-size: 16px;"></span><span class="error text-danger"  style="line-height:1.5;font-size: 16px;"> <?php echo $pwdErr;?></span>
                                                  </div>

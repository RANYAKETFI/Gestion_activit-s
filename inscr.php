...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["user"])) {
    $userErr = "Nom du club est requis";
  } else {
       $user = test_input($_POST["user"]);
    // check if name only contains letters and whitespace
    if (!preg_match("/^[a-zA-Z ]*$/",$user)) {
      $userErr = "Veuillez entrer que des lettres et des espaces";
      $user =""; 
    } 
  }
  ...
  if (empty($_POST["email"])) {
    ...
    {  
     ...
     $email = $email1 ;
        ...
        { 
          $emailErr = "Veuillez entrer Email de l'ESI"; 
        }
...
//-------------------------------------
  if (empty($_POST["pwd2"])) {
    $pwd2Err = "confirmation du mot de passe est requise";
  } else {
...
//----the input
$pro = "Club"; 
if(($user != "") and ($email != "") and ($pwd != "") and ($pwd2 != "")  )
{  if($pwd == $pwd2)
    {
...
echo "<script>
    window.location.assign('./inscriptions_success.php');
        ...
        alert("Le compte existe déja ! ! !");
         </script>';
        exit;
  }
    }
    else {
       // echo "  Mot de passe n'est pas confirmé  ";
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 register-right">
                        ...
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link"  data-toggle="tab" href="#" role="tab" aria-controls="club" aria-selected="true">Club</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link"  data-toggle="tab" href="./etud.php" role="tab" aria-controls="etudi" aria-selected="true">Etudiant</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link"  data-toggle="tab" href="./prof.php" role="tab" aria-controls="etudi" aria-selected="true">Ens</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="club" role="tabpanel" >
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" name="Formaulaire">
                                             ...
                                             <h3 class="register-heading">S'inscrire en tant que Club</h3>
                                <div class="row register-form">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Nom du Club*" value="" name="user" id="nom" /><span class="error-message text-danger"></span>
                                        </div><br>
                                        <div class="form-group">
...
echo "<br>";
echo "Le email est : ".$email;
echo "<br>";
echo "Le password est : ".$pwd;
echo "<br>";
echo "La confirmation du password est : ".$pwd2;
echo "<br>";
*/
          ?>

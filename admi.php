...
<?php 
  ...
  $user  = $pwd =$email  = $nom = $prenom = $pwd2 ="";

$userErr = $emailErr= $pwdErr = $prenomErr = $nomErr = $pwd2Err ="";
  ...
  if (empty($_POST["email"])) {
    ...
    {  
     ...
     $email = $email1 ;
        ...
        { 
          $emailErr = "Invalid esi email format"; 
        }
...
$user = $nom." ".$prenom;
///---------------------
if(($user != "") and ($email != "") and ($pwd != "") )
{
   if($pwd2 == $pwd){$trouve = Rechercher_user($user,$email);
  if( $trouve == 0)
  {
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 register-right">
                        ...
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link"  data-toggle="tab" href="./prof.php" role="tab" aria-controls="prof" aria-selected="true">Ens</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link"  data-toggle="tab" href="#" role="tab" aria-controls="pers" aria-selected="true">Pers</a>
                            </li>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="club" role="tabpanel" >
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" name="Formaulaire">
                                             ...
                                             <h3 class="register-heading">S'inscrire en tant que Personnel</h3>

                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 register-right">
                        ...
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link"  data-toggle="tab" href="#" role="tab" aria-controls="etudi" aria-selected="true">Etudiant</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link"  data-toggle="tab" href="./prof.php" role="tab" aria-controls="prof" aria-selected="true">Ens</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link"  data-toggle="tab" href="./admi.php" role="tab" aria-controls="pers" aria-selected="true">Pers</a>
                            </li>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="club" role="tabpanel" >
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" name="Formaulaire">
                                             ...
                                             <h3 class="register-heading">S'inscrire en tant que Etudiant</h3>

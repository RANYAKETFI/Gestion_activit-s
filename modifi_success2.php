...
<br>
  <h2 class="lead" style=" color : #f5f6f6;"> Votre nom d\'utilisateur a bien été modifié ! Pour revenir vers votre profil, cliquez sur ce boutton.</h2>
  <p class="lead" style="color : #f5f6f6;">
    <a class="btn btn-primary btn-sm verif" href='.$acc.' role="button">Accueil</a>
  </p>
  <hr>
  <p style=" color : #f5f6f6;">
    Pour plus d\'informations veuillez consulter <a href='.$aide.' style="color:#85d3c5;"> l\'aide en ligne </a> de notre application. <a href="<?php echo $aide; ?>"></a>
  </p>

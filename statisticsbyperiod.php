...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Statistiques par période</title>
...
$(document).ready(function() {
 ...
 <div class="tab-content">
   ...
   <table id="table" class=" display row-border  " style="width:100%">
     ...
     <tbody>
       <?php
       function statisticsbyperiod($date1,$date2)
         ...
         $conn = mysqli_connect($servername, $username, $password,$dbname);
           ...
           if (!$conn) // connexion échouée
          {
           ...
           { // récuperer l'is de cette salle
             ...
             $cmd="SELECT `id_res`, `id_user`,`id_salle`, `date`, `h_deb`, `h_fin`, `an_resp`,`matricule_resp`, `description` FROM `reservation` WHERE   accord=1 AND date between '$date1' AND '$date2' AND accept=1 AND annul=0";
             ...
             while($row = mysqli_fetch_assoc($result))
              {
                ...
                $descrp=$row["description"];
                   ...
                   echo "<tr><td>".$id_res."</td><td>".$user."</td><td>".$salle."</td><td>".$date."</td><td>".$hd."-".$hf."</td><td>".$descrp."</td></tr>";
                   echo'   ';
               ...
               echo"</table>";
              echo "</div>";
              // reservation annulées
              echo '<div id="menu1" class="tab-pane fade">';
              echo "<br>";
              echo ' <h2 align="center">Les évenements annulés</h2>
              <hr width="15%" style="border-top-color: #a5b1c2;">
              <br>
              ...
              $cmd2="SELECT `id_res`, `id_user`,`id_salle`, `date`, `h_deb`, `h_fin`, `an_resp`,`matricule_resp`, `description` FROM `reservation` WHERE   accord=1 AND date between '$date1' AND '$date2' AND accept=1 AND annul=1";
           ...
           $today=date('Y-m-d');
             ...
             {
           statisticsbyperiod($date1,$date2);
             }
